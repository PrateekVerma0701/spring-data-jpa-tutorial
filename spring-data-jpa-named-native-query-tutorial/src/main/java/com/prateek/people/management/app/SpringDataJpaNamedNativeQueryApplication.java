...
public class SpringDataJpaNamedNativeQueryApplication implements CommandLineRunner {

	@Autowired
	private PeopleMangementService peopleMangementService;

	public static void main(String[] args) {
		SpringApplication.run(SpringDataJpaNamedNativeQueryApplication.class, args);
	}
